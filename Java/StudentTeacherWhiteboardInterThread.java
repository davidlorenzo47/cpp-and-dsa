...
public class StudentTeacherWhiteboardInterThread 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("Here the order of output is not Important. Every student has read the sentence that is important.");
